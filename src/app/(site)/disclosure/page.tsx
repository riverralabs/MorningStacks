...
export default function DisclosurePage() {
  return (
    <Paper eyebrow="Disclosure" title="Affiliate disclosure">
      ...
      <p>
        MorningStacks is published by Riverra Labs LLP. Some links from this site to vendor sites include the
        query <code>via=morningstacks</code>. If you then buy or start a paid plan, the vendor or its affiliate
        network may pay Riverra Labs LLP a commission. You do not pay more because you used our link.
      </p>
      <p>
        Not every link is an affiliate link. Reviews and roundups will typically use affiliate links for the
        products they cover. Legal pages, this disclosure, methodology, and our own site pages do not.
      </p>
      ...
      <p>
        ...
        of the page, in addition to this site-wide page. Affiliate links are marked in the page source with{' '}
